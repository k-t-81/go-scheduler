...
const TestTaskName = "github.com/algorythma/go-scheduler/task.(*CallbackMock).CallNoArgs-fm"
...
func TestPopulateTasks(t *testing.T) {
	...
	taskAttributes := storage.TaskAttributes{
		...
		Duration:    "5s",
		IsRecurring: "0",
		Name:        "github.com/algorythma/go-scheduler/task.(*CallbackMock).CallNoArgs-fm",
		Params:      "",
	}
