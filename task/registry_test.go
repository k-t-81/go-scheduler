...
func TestGet(t *testing.T) {
	...
	getResult, err := funcRegistry.Get("github.com/algorythma/go-scheduler/task.(*CallbackMock).CallNoArgs-fm")
...
func TestExists(t *testing.T) {
	...
	found = funcRegistry.Exists("github.com/algorythma/go-scheduler/task.(*CallbackMock).CallNoArgs-fm")
	if !found {
